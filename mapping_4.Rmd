...
bivariate_data <- bi_class(nc_poly, x = income_ratio, y = uninsured, 
                           dim = 3, style = "quantile")

legend <- bi_legend(pal = "magma",
                    dim = 3,
                    xlab = "Income ratio",
                    ylab = "Unisured",
                    size = 6)
